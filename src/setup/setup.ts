...
export const teamMasterMenu = [
  {
    title: 'edit profile',
    links: [
      { linkfor: 'basic info', path: '/masterInfo' },
      { linkfor: 'profile image', path: '/profileImages' },
    ],
  },
  {
    title: 'mange team',
    links: [
      ...
      { linkfor: 'info', path: '/teamInfo' },
      { linkfor: 'about', path: '/teamAbout' },
      { linkfor: 'cover image', path: '/teamImage' },
      { linkfor: 'links', path: '/teamLinks' },
      { linkfor: 'theme', path: '/teamTheme' },
    ],
  },
  {
    title: 'contacts',
...
export const adminMenu = [
  {
    title: 'batches',
    links: [
      { linkfor: 'batches list', path: '/batches' },
      { linkfor: 'create batch', path: '/createBatch' },
    ],
  },
  {
    title: 'users',
    links: [
      { linkfor: 'users list', path: '/users' },
      { linkfor: 'teams list', path: '/teams' },
    ],
  },
  {
    title: null,
